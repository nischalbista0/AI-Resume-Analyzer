                ...
                <div className="flex  justify-center w-full  items-center  ">
                  <div className="bg-white flex md:w-2/5 w-4/5">
                    ...
                    <input
                      ...
                      type="text"
                      className="outline-none   text-black px-2 pl-3 md:h-10 w-full h-8 py-1 text-sm"
                    />
                    ...
                    <button
                      ...
                      className="blueCol px-4 md:h-10 h-8 py-1"
                    >
                      Search
                    </button>
                  </div>
                ...
                <div className="filter1  md:flex hidden flex-col">
                  <div className="flex justify-start  flex-col filter  ">
                    ...
                    <div className="flex flex-col gap-4 w-2/3 pt-5">
                      <button
                        onClick={() => filter()}
                        className="blueCol px-1 py-1 text-sm"
                      >
                        Apply Filter
                      </button>
                      <button className="blueCol px-1 py-1 text-sm">
                        Remove Filter
                      </button>
                    </div>
                  </div>
