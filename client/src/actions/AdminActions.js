...
export const getAllJobsAdmin = () => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(
      "http://localhost:3000/api/v1/admin/allJobs",
      config
    );
...
export const getAllAppAdmin = () => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(
      "http://localhost:3000/api/v1/admin/allApp",
      config
    );
...
export const getAppData = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(
      `http://localhost:3000/api/v1/admin/getApplication/${id}`,
      config
    );
  ...
  try {
    ...
    if (dataBody.status === "not") {
      ...
      const { data } = await axios.put(
        `http://localhost:3000/api/v1/admin/updateApplication/${id}`,
        dataBody,
        config
      );
...
export const deleteApp = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.delete(
      `http://localhost:3000/api/v1/admin/deleteApplication/${id}`,
      config
    );
...
export const deleteJobData = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.delete(
      `http://localhost:3000/api/v1/admin/deleteJob/${id}`,
      config
    );
